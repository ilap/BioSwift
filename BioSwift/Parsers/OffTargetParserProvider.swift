...
enum OffTargetParserProvider {
    static func factory(type: OffTargetParserType) -> ParserProtocol {
        switch type {
        case .CasOffinder:
            return CasOffinderOuptuOutputParser()
        case .Bowtie:
...
enum OffTargetParserType: String {
    ...
    static func getTypeFromExtension (ext: String) ->  OffTargetParserType? {
        switch ext {
